      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              href={`https://wa.me/56927389896?text=${encodeURIComponent(`Hola! Me interesa cotizar el *${product.name}*. ¿Podrían brindarme más información sobre precio y disponibilidad?`)}`}
              target="_blank"
            ...
            <Link
              href="/catalogo"
              className="flex-1 border border-gray-200 hover:border-[#1e40af] text-gray-700 hover:text-[#1e40af] font-semibold py-3 px-6 rounded-xl text-center transition-colors"
            >
              Ver más productos
            </Link>
          </div>
